...
<div class="grid-item grid-item-RA" style="background: #EDD7DB; color: #842A3D; border: 1px solid #EDD7DB; padding: 20px; border-radius: 20px; box-shadow: 3px 0px 3px 0px rgba(0, 0, 0, 0.1);">
<div>
...
<div class="grid-item grid-item-RA" style="background: #EDD7DB; color: #FFFFFF; border: 1px solid #EDD7DB; padding: 20px; border-radius: 20px; box-shadow: 3px 0px 3px 0px rgba(0, 0, 0, 0.1);">
<div>
...
absolute<- data.frame(
	measurement = c(rep("absolute",6)),
	type = c(rep("pros",3), rep("con", 3)),
	description = c("Offers clear information about the actual risk difference, which is often more relevant for patients and policymakers.", "More directly applicable to individual decision-making, as they reflect real-world implications of health interventions.",
	"Helps in assessing the burden of disease and planning interventions by showing how many cases could potentially be prevented.", "May not provide a complete picture if used alone, as they do not account for the relative context of risks across populations.", "The interpretation can vary significantly based on population characteristics, which may lead to different conclusions in subgroup analyses.", NA)
	)

relative<- data.frame(
	measurement = c(rep("relative",4)),
	type = c(rep("pros",2), rep("con", 2)),
	description = c("Facilitates comparisons across different studies and populations by standardizing risk assessments.", "Effective in demonstrating the strength of associations between exposures and outcomes, particularly in clinical trials.", "Can exaggerate perceived benefits or risks, especially when absolute risks are low; for instance, a treatment might reduce mortality by 50%, but if the baseline risk is very low, the actual benefit may be minimal.", "May lead to neglecting important absolute differences that could inform better health decisions.")
	)

df <- rbind(absolute, relative)

df %>% group_by(measurement) %>% gt()
...
<div>
<div style="border-radius: 12px 12px 0px 0px; font-size: 25px; color: #fff;background-color: #B56576; height: 50px; width:50px;">
</div>

<div style="border-radius: 12px 12px 0px 0px; font-size: 25px; color: #fff;background-color: #B56576; height: 280px; width:50px;">
<p style="font-weight: 900; margin: 0; transform: rotate(-90deg);transform-origin: left top; justify-content: center;">Pros</p>
</div>
...
<!-- Absolute-->
<div>
<div style="border-radius: 12px 12px 0px 0px;
								font-size: 25px;
								font-weight: 800;
								color:#fff;
								display: flex;
...
<div style="border-radius: 0px 0px 12px 12px;
								font-size: 25px;
								font-weight: 100;
								text-align: left;
								height:280px;
...
<div style="border-radius: 0px 0px 12px 12px;
								...
								background-color: #EDD7DB;">
<!-- Pros relative -->								
<p style="margin-top: 0; padding: 10px; font-weight: 400; text-align: center;">Pros</p>
<ul style="font-size: 20px; padding: 10px;">

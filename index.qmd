...
<div class="grid-container" style="grid-template-columns: 1fr 1fr; gap: 100px;">
<div class="grid-item">
<i class="fa-solid fa-people-group" style="color: #6D597A"></i>
<div>
<h3>Prevalence indicates</h3>
...
<h3 style="font-weight: 900;">Prevalence \( P \) is calculated as:</h3>

<!--\begin{aligned} P= \frac{\text{Number of Current Cases}}{\text{Total Population at a Specific Time}}\end{aligned} -->

$$\frac{\text{Number of Current Cases}}{\text{Total Population at a Specific Time}}$$
...
<h2 style="text-align: center; font-weight: 800">QUIZ</h2>
...
## Absolute differences in measures

<p style="text-align: center;">Describes the difference between the probability that an event/outcome (e.g. an ADR/disease) occurs or not:

Definition: Absolute measures express the actual difference in risk or incidence between two groups, typically an exposed group and an unexposed group. Common examples include risk difference and attributable risk.
...
<p style="font-size: 20px; text-align: center;">No Unit</p>
</li>
<li class="fragment" >Incidence rate difference (IRD)
$$IRD= \text{IR}_{\text{Exposed}} - \text{IR}_{\text{Unexposed}}$$
<p style="font-size: 20px; text-align: center;">Unit: per person-years (such as incidence rate)</p>
</li>
